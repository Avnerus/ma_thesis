...
author: Avner Peled.
date: 09/2019
abstract: This thesis is a post-phenomenological interrogation into the use of soft robots as mediating bodies between humans, attempting to unfetishise their imaginative figure of the stranger through an event I call incarnation. Based on my own encounters with Palestinians for conflict resolution and through readings of phenomenological and sociological studies, I determine the importance of the physical body, its fleshiness, nonlinearity and organic qualities for the construction of a meaningful and transformative dialog that can free us from fetishizing of the stranger. Furthermore, I investigate the potential of non-human robotic avatars to achieve intercorpreality and liberate the interlocutors from prejudice and identity constraints. I propose the use of soft robots as a medium of re-embodiment that could facilitate massive scale physical incarnations, creating physical encounters between people who are unable to otherwise meet in person. As a proof-of-concept, a novel method for the production of soft robotic avatars is introduced, capable of bodily haptics, language translation and animalistic emotional expression. The robots are operated using a web-based software platform that enables easy development of third party applications. Using this method, HITODAMA, a first prototype for a soft robotic avatar, is produced. I perform an initial evaluation of the robot in an encounter between people of different cultures, using an example app in which they get to know one another through pictures. I analyze the results by conducting interviews with the participants, following the principles of interpretative phenomenological analysis.
indent: true
csl: apa2.csl
header-includes: |
    \usepackage{xeCJK}
...
Once those aspects are determined and a variety of related work is presented, the soft robot HITODAMA is outlined as a solution that seeks to optimally fulfill the phenomenological requirements. The design choices and production methods are detailed, along with preliminary qualitative user test analysis.
...
### Goals
Following the production of the aforementioned design, The experiment evaluates the first prototype of HITODAMA under the frameworks of incarnation, re-embodiment and intercorporeality. The following primary goals were defined:
