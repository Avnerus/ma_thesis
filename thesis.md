...
### Motor subsystem
HITODAMA is a pneumatics-based soft robot that operates on inflating silicone actuators. Table [@tbl:actuators] provides an overview of the different actuators and their function, accompanied by a visual mapping of the actuators (see [@fig:hitodama-motor]). A more detailed specification of each actuation will be specified in dedicated sections.
